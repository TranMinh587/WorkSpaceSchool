...
// 541 Nh?p t?a d? di?m trong m?t ph?ng
...
// 542 Xu?t t?a d? di?m trong m?t ph?ng
void XuatDiem(DIEM a)
{
    printf("<%.2f, %.2f>", a.X, a.Y);
}

// 543 Tính kho?ng cách gi?a 2 di?m
...
// 544 Tính kho?ng cách gi?a 2 di?m theo phuong Ox
float TinhKhoangCachGiua2DiemTheoOx(DIEM a, DIEM b)
{
    return fabs(a.X - b.X);
}

// 545 Tính kho?ng cách gi?a 2 di?m theo phuong Oy
float TinhKhoangCachGiua2DiemTheoOy(DIEM a, DIEM b)
{
    return fabs(a.Y - b.Y);
}

//546 Tìm t?a d? di?m d?i x?ng qua g?c t?a d?
...
//547 Tìm di?m d?i x?ng qua tr?c hoành
...
//548 Tìm di?m d?i x?ng qua tr?c tung
...
//549 Tìm di?m d?i x?ng qua du?ng phân giác th? 1 (y = x)
...
//550 Tìm di?m d?i x?ng qua du?ng phân giác th? 2 (y = -x)
...
//551 Ki?m tra di?m thu?c ph?n tu th? 1 ko?
...
//552 Ki?m tra di?m thu?c ph?n tu th? 2 ko?
...
//553 Ki?m tra di?m thu?c ph?n tu th? 3 ko?
...
//554 Ki?m tra di?m thu?c ph?n tu th? 4 ko?
